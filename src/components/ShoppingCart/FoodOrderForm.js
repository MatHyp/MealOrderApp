...
const FoodOrderForm = (props) => {
  ...
  const onFormSubmit = (e) => {
    ...
    fetch(
      "https://meal-e71bf-default-rtdb.europe-west1.firebasedatabase.app/Orders.json",
      {
        method: "POST",
    ...
    <div>
      <form onSubmit={onFormSubmit}>
        ...
        <input
          ...
          value={state.name}
          onChange={(e) => {
            onChangeFormHandler(e, types.name);
          }}
        />
        ...
        <input
          ...
          className="labels"
          value={state.street}
          onChange={(e) => onChangeFormHandler(e, types.street)}
        />
        ...
        <input
          ...
          onChange={(e) => onChangeFormHandler(e, types.postCode)}
        />
        ...
        <input
          ...
          className="labels"
          value={state.city}
          onChange={(e) => onChangeFormHandler(e, types.city)}
        />
